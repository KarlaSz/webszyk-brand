        ...
        <div className="space-y-6 mb-16">
          ...
          <Card className="relative border border-white/30 backdrop-blur-md bg-black/30 shadow-2xl rounded-2xl overflow-hidden group hover:scale-[1.02] transition-all duration-300">
            ...
            <CardContent className="pt-0">
              ...
              <Button className="w-1/2 py-3 text-lg group bg-white/20 border border-white/30 hover:bg-gradient-to-r hover:from-orange-400 hover:to-orange-600 hover:border-orange-500 text-white backdrop-blur-md transition-all duration-300">
                Get Started Today
