        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 text-center shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" className="px-8 py-3 text-lg group bg-gradient-to-r from-orange-400 to-orange-600 border border-orange-500 hover:bg-gray-400/20 hover:border-gray-300/30 text-white backdrop-blur-md transition-all duration-300">
