        ...
        <div className="space-y-6 mb-16">
          ...
          <Card className="relative border border-white/30 backdrop-blur-md bg-black/30 shadow-2xl rounded-2xl overflow-hidden group hover:scale-[1.02] transition-all duration-300">
            ...
            <CardContent className="pt-0">
              ...
              <Button className="w-1/2 py-3 text-lg group bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 text-white border-0">
                Get Started Today
            ...
            <CardContent className="pt-0">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Cloud className="h-4 w-4 text-indigo-400 flex-shrink-0" />
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <HeadphonesIcon className="h-4 w-4 text-pink-400 flex-shrink-0" />
                    <span className="text-white/90 text-sm">24/7 support</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Code className="h-4 w-4 text-emerald-400 flex-shrink-0" />
