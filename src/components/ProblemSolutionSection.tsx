        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-600 truncate">{problem.description}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          <div className="lg:col-span-1 flex items-center justify-center">
            <div className="relative">
              <div className="w-20 h-20 bg-gradient-to-r from-red-100 to-[#4CAF50]/20 rounded-full flex items-center justify-center shadow-lg">
                <ArrowRight className="h-8 w-8 text-[#4CAF50]" />
              </div>
              <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-center">
                <div className="bg-white px-3 py-1 rounded-lg shadow-md border border-[#4CAF50]/20 text-xs font-medium text-[#4CAF50]">
                  WebSzyk Transforms
                </div>
              </div>
            </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-600 truncate">{solution.description}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
